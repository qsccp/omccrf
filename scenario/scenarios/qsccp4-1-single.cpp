...
namespace ns3
{
    ...
    main(int argc, char *argv[])
    {
        ...
        consumerHelper.SetAttribute("MaxSeq", UintegerValue(5000));
        ...
        ndn::L3RateTracer::InstallAll("omccrf-single-throughput.txt", Seconds(0.1));
        ndn::AppDelayTracer::InstallAll("omccrf-single-delay.txt");
        L2RateTracer::InstallAll("omccrf-single-drop.txt", Seconds(0.1));
        Simulator::Run();
        Simulator::Destroy();
